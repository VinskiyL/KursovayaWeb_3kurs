...
import './order.css';
import imgAdd from './addOrder.png'; // Убедитесь, что путь к изображению правильный
...
const New = () => {
    ...
    return (
        <div className="container_order">
            ...
            <form onSubmit={handleSubmit} className = "container_order--form">
                <div className="container_order--el">
                ...
                <div className="container_order--el">
                 ...
                 <button className="order-button" type="submit">
                     <img className='search' src={imgAdd} alt="search" />
                 </button>
             </form>
         </div>
     );
